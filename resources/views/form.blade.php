...
<header class="mastheadform">
        <body class="hold-transition layout-top-nav">
            ...
            <div class="content-wrapper">  
             ...
             <div class="content">  
              <div class="container">
                ...
                @endif
            <form method="POST" action="/form" enctype="multipart/form-data"  id="form" role="form">
              @csrf
              <div class="row">		
                  <div class="col-lg-12">
                      <div class="card">
                        <div class="card-header bg-gradient-info">
                          <h3 class="card-title">Formulir Permohonan Ambulan/Mobil Jenazah</h3>
                        </div>                           
                          <div class="card-body">  
                            <div class="row">
                              <div class="col-md-6">                  
                            <label style="font-size:1.2rem">Pemesan / Penanggung jawab</label>
                            ...
                            <div class="form-group row">
                              <label for="nohp" class="col-sm-4 col-form-label">No HP/WA (untuk berkoordinasi)</label>
                              <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                              <label for="jenis" class="col-sm-5 col-form-label">Saya ingin memesan </label>
                              <div class="col-sm-7">
                            ...
                            <div class="form-group row" id="infeksi-wrapper">
                              <label for="infeksius" class="col-sm-5"><span>Kategori Infeksius</span><br/>
                            ...
                            <div class="col-md-6">
                                  <label style="font-size:1.2rem">Penjemputan</label>
                                  <div class="form-group row">
            ...
            <div class="card-body" style="display: block;">
              <ol>
              <li>Layanan ambulance dan mobil jenazah yang disediakan oleh MyAmbulance adalah GRATIS dan melayani lintas SARA.</li>
              <li>Aplikasi ini dikelola oleh OneSquad sedangkan mobil ambulance dioperatori oleh jaringan web Myambulance.</li>
              <li>Aplikasi ini disediakan untuk warga Daerah Istimewa Yogyakrata dalam mendapatkan fasilitas ambulan dan mobil jenazah secara mudah dan cepat.
              </li>
              <li>Layanan ambulan dan mobil jenazah tergantung pada ketersediaan unit mobil pada saat pemohon mengajukan permohonan melalui aplikasi.</li>
              <li>Layanan ambulan disediakan untuk segala sesuatu yang berhubungan dengan orang sakit, antara lain ; antar jemput pasien ke rumah sakit, antar pasien dari satu lokasi ke lokasi lainnya, menjemput korban kecelakaan dan lain sebagainya.</li>
              ...
              <li>Pemohon diharapkan memberikan informasi yang akurat terhadap kondisi pasien kepada operator MyAmbulance.Pemohon diharapkan memberikan informasi yang akurat terhadap kondisi pasien kepada operator MyAmbulance.</li>
              ...
              <li>Kami membutuhkan photo KTP anda hanya sebagai media verifikasi. Kami tidak menyimpan KTP anda di server kami dan tidak pula membagikannya kepihak lain termasuk driver ambulan kami. Sebagai langkah preventif keamanan data anda, silahkan tutup NIK anda dengan jari / benda lain atau diedit terlebih dahulu sebelum dikirim ke kami.</li>
              <li>Hubungi call center kami di .... untuk info lebih lanjut.</li>
            </ol>
            </div>
            {{-- card body --}}
          </div>
