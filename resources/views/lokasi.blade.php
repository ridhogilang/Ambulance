...
<header class="mastheadform">
    <div class="container mt-5">
        <h1 class="namepost sm:text-2xl sm:truncat">Halaman untuk relawan : {{ $lokasi }}</h1>
        <p class="keterangan mb-5">Informasi - Ambulance Gratis di {{ $lokasi }}, D.I. Yogyakarta yang dikumpulkan relawan melalui pencarian di internet atau media sosial.
        <div class="cardrelawan">
            ...
            {{-- <br>
                        <br>
                        <a href="/relawan" class="ml-5"><i class="fa-solid fa-arrow-left rounded-cicrle"></i> Back to All Relawan</a>
                        <br>
                        <br>
                        <br> --}}
        </div>
