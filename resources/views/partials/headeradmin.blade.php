        ...
        ***********************************-->
        <div class="nav-header">
            <a href="/dashboard" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('css/dash.png') }}" alt="">
                <img class="logo-compact" src="{{ asset('css/text.png') }}" alt="">
                <img class="brand-title" src="{{ asset('css/text.png') }}" alt="">
            </a>
					...
					<div class="tab-pane fade active show" id="chat" role="tabpanel">
						...
						<div class="card chat dz-chat-history-box d-none">
							<div class="card-header chat-list-header text-center">
								...
								<div class="dropdown">
									<a href="#" data-toggle="dropdown" aria-expanded="false"><img src="https://i.postimg.cc/HW31Mkb1/ridho.jpg"/><svg xmlns="https://i.postimg.cc/HW31Mkb1/ridho.jpg" xmlns:xlink="https://i.postimg.cc/HW31Mkb1/ridho.jpg" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/><circle fill="#000000" cx="5" cy="12" r="2"/><circle fill="#000000" cx="12" cy="12" r="2"/><circle fill="#000000" cx="19" cy="12" r="2"/></g></svg></a>
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/profile" class="dropdown-item ai-icon">
                                        ...
                                        <span class="ml-2">Profile | {{ auth()->user()->name }} </span>
                                    </a>
                                    ...
                                    <form action="/logout" method="POST" class="dropdown-item ai-icon">
                                        ...
                                        <button type="submit" class="ml-2" id="btlog">Log Out</button>
                                      </form>
                                </div>
                            </li>
                        </ul>
