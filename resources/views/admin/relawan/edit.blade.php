        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('dashrelawan.update', $post->id) }}">
                        @method('PUT')
                        @csrf
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control @error('name')is-invalid @enderror" id="name" name="name" placeholder="Nama Relawan" value="{{ old('name', $post->name) }}" >
                                                @error('name')
                                            ...
                                            <div class="col-lg-6">
                                                {{-- <select name="lokasi_id" id="lokasi_id" class="form-control">
                                                    @foreach ($lokasi as $lokasi)
                                                        @if (old('jenis_id', $post->jenis_id) == $lokasi->id)
                                                            <option value="{{ $lokasi->id }}" selected>{{ $lokasi->kabupaten }}</option>
                                                        @else
                                                            <option value="{{ $lokasi->id }}">{{ $lokasi->kabupaten }}</option>
                                                        @endif
                                                    @endforeach
                                                </select> --}}
                                                <input type="text" class="form-control  @error('lokasi_id')is-invalid @enderror" id="lokasi_id" name="lokasi_id" placeholder="Lokasi" value="{{ old('lokasi_id', $post->lokasi_id) }}">
                                                @error('lokasi_id')
                                                <div class="invalid-feedback">
                                                  {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control  @error('nomor')is-invalid @enderror" id="nomor" name="nomor" placeholder="No HP/WA" value="{{ old('nomor', $post->nomor) }}">
                                                @error('nomor')
                                                <div class="invalid-feedback">
                                                  {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control  @error('vertifikasi')is-invalid @enderror" id="vertifikasi" name="vertifikasi" placeholder="Status Vertifikasi" value="{{ old('vertifikasi', $post->vertifikasi) }}">
                                                @error('vertifikasi')
                                                <div class="invalid-feedback">
                                                  {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control @error('via_vertifikasi')is-invalid @enderror" id="via_vertifikasi" name="via_vertifikasi" placeholder="Via Vertifikasi" value="{{ old('via_vertifikasi', $post->via_vertifikasi) }}">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control @error('plat_nomor')is-invalid @enderror" id="plat_nomor" name="plat_nomor" placeholder="Plat Nomor Mobil" value="{{ old('plat_nomor', $post->plat_nomor) }}">
                                                @error('plat_nomor')
                                                <div class="invalid-feedback">
                                                  {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control @error('kondisi_mobil')is-invalid @enderror" id="kondisi_mobil" name="kondisi_mobil" placeholder="Kondisi Mobil" value="{{ old('kondisi_mobil', $post->kondisi_mobil) }}">
                                                @error('kondisi')
                                                <div class="invalid-feedback">
                                                  {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control @error('foto_dalam')is-invalid @enderror" id="foto_dalam" name="foto_dalam" placeholder="Foto Dalam Mobil" value="{{ old('foto_dalam', $post->foto_dalam) }}">
                                                @error('foto_dalam')
                                                <div class="invalid-feedback">
                                                  {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input class="form-control @error('foto_luar')is-invalid @enderror" id="foto_luar" name="foto_luar" placeholder="Foto Luar Mobil" value="{{ old('foto_luar', $post->foto_luar) }}">
                                                @error('foto_luar')
                                                <div class="invalid-feedback">
                                                  {{ $message }}
                                                </div>
