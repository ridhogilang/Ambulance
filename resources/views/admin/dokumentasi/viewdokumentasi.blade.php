                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <span class="form-control">{{ $post->jenis_id }}</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <span class="form-control">{{ $post["almarhum"] }}</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group row mt-5">
                                        ...
                                        <div class="col-lg-3">
                                            <a href="" type="submit" class="btn btn-primary"><i class="fa fa-pencil"></i> Edit</a>
                                        </div>
                                        <div class="col-lg-3">
