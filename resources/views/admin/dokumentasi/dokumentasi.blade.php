            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary" href="/dokumentasi/create">New Dokumentasi</a>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="example3" class="display min-w850">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('dokumentasi.show', $post->nama) }}" class="btn btn-secondary shadow btn-xs sharp mr-1"><i class="fa fa-eye"></i></a>
                                                <a href="{{ route('dokumentasi.edit', $post->nama) }}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                <form action="{{ route('dokumentasi.destroy', $post->id) }}" method="POST">
                                                    @method('delete')
                                                    @csrf
                            ...
                            <table id="example3" class="display min-w850">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('permohonan.show', $post->nama) }}"
                                                    class="btn btn-secondary shadow btn-xs sharp mr-1"><i
                                                        class="fa fa-eye"></i></a>
                                                <a href="{{ route('permohonan.edit', $post->nama) }}"
                                                    class="btn btn-primary shadow btn-xs sharp mr-1"><i
                                                        class="fa fa-pencil"></i></a>
                                                <form action="{{ route('permohonan.destroy', $post->nama) }}"
                                                    method="POST">
                                                    @method('delete')
                                                    @csrf
                                                    <button class="btn btn-danger shadow btn-xs sharp"
